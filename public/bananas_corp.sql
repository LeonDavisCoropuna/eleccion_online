...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-07-2023 a las 08:48:12
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtener_datos_partido_candidatos` ()   BEGIN
    SELECT pp.id AS id_partido, pp.partido AS nombre_partido, r.nro_votos, c.id AS id_candidato, c.cargo, pe.nombre, pe.apellido
...
INSERT INTO `persona` (`id`, `nombre`, `apellido`, `username`, `password`) VALUES
